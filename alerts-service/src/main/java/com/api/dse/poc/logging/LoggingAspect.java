package com.api.dse.poc.logging;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* com.api.dse.poc.controller.*.*(..)) || execution(* com.api.dse.poc.services.*.*(..)) || execution(* com.api.dse.poc.dao.*.*(..))")
	private void selectAll() {
	}

	@AfterReturning(pointcut = "execution(* com.api.dse.poc.controller.*.*(..))", returning = "retVal")
	...
	@Pointcut("execution(* com.api.dse.poc.controller.*.*(..))")
